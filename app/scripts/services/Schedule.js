...
angular.module('AppMod2014App')
	...
	return {
		...
		}, 
		{
		    "slots": [
			{
			    "slot": "<2014-03-11 Tue 10:40-12:00>", 
			    "sessions": [
				{
				    "room": "TBD", 
				    "name": "FMI 1", 
				...
				{
				    "room": "TBD", 
				    "name": "Automotive Applications 1", 
				    "papers": [
					"9", 
					"40", 
					"42", 
				...
				{
				    "room": "TBD", 
				    "name": "Building energy applications 1", 
				    "papers": [
					"19", 
					"39", 
					"137", 
				...
				{
				    "room": "TBD", 
				    "name": "Electro-Magnetic Models and Libraries 1", 
				    "papers": [
					"3", 
					"4", 
					"22", 
				...
				{
				    "room": "TBD", 
				    "name": "Modelica Language & Compiler Implementation", 
				    "papers": [
					"61", 
					"103", 
					"136", 
			...
			{
			    "slot": "<2014-03-11 Tue 13:20-14:40>", 
			    "sessions": [
				{
				    "room": "TBD", 
				    "name": "FMI 2", 
				...
				{
				    "room": "TBD", 
				    "name": "Automotive Applications 2", 
				    "papers": [
					"73", 
					"75", 
					"78", 
				...
				{
				    "room": "TBD", 
				    "name": "Building energy applications 2", 
				    "papers": [
					"160", 
					"69", 
					"84", 
				...
				{
				    "room": "TBD", 
				    "name": "Electro-Magnetic Models and Libraries 2", 
				    "papers": [
					"32", 
					"119", 
					"129"
			...
			{
			    "slot": "<2014-03-11 Tue 14:00-15:20>", 
			    "sessions": [
				{
				    "room": "TBD", 
				...
				{
				    "room": "TBD", 
				    "name": "Power, Energy & Process Applications 2", 
				    "papers": [
					"126", 
					"166", 
					"173", 
				...
				{
				    "room": "TBD", 
				    "name": "Optimization Applications and Methods", 
				    "papers": [
					"6", 
					"29", 
					"95", 
				...
				{
				    "room": "TBD", 
				    "name": "Web-related Modelica Tools", 
				    "papers": [
					"168", 
					"30", 
					"170", 
			...
			{
			    "slot": "<2014-03-11 Tue 15:10-16:30>", 
			    "sessions": [
				{
				    "room": "TBD", 
				    "name": "Automotive Applications: FMI & HIL", 
				    "papers": [
					"56", 
					"159", 
					"175", 
				...
				{
				    "room": "TBD", 
				    "name": "Fault Handling and Safety Issues in Modelica", 
				    "papers": [
					"48", 
					"100", 
					"38", 
				...
				{
				    "room": "TBD", 
				    "name": "Novel Modelica Applications and Libraries", 
				    "papers": [
					"12", 
					"122", 
					"154", 
		...
		}, 
		{
		    "slots": [
			{
			    "slot": "<2014-03-12 Wed 09:15-10:30>", 
			    "sessions": [
				{
				    "room": "TBD", 
				    "name": "Aerospace Applications 1", 
				    "papers": [
					"76", 
					"82", 
					"142"
				...
				{
				    "room": "TBD", 
				    "name": "Thermofluid Systems Models and Libraries 1", 
				    "papers": [
					"117", 
					"123", 
					"172"
			...
			{
			    "slot": "<2014-03-12 Wed 11:00-12:20>", 
			    "sessions": [
				{
				    "room": "TBD", 
				    "name": "Aerospace Applications 2", 
				    "papers": [
					"8", 
					"10", 
					"45", 
				...
				{
				    "room": "TBD", 
				    "name": "Power, Energy & Process Applications 1", 
				    "papers": [
					"87", 
					"52", 
					"79", 
				...
				{
				    "room": "TBD", 
				    "name": "Numerical Aspects of Modelica Tools", 
				    "papers": [
					"158", 
					"147", 
					"80", 
				...
				{
				    "room": "TBD", 
				    "name": "Thermofluid Systems Models and Libraries 2", 
				    "papers": [
					"2", 
					"23", 
					"102", 
		...
		"22": {
		    ...
		    "title": "The New EDrives Library: A Modular Tool for Engineering of Electric Drives"
		}, 
		"23": {
		...
		"58": {
		    "abstract": "As part of the e-MOBILie project sponsored by the Federal Ministry for the Environment, electro mobility has to be combined with local renewable generation in an integrated approach. Integrated energy management also includes forecasting technologies for weather and load profiles and allows for scalability from individual consumers to fleet applications. These concepts will be systematically implemented in simulations as well as tested with hardware in conditions approximating a real-world application. The focus of this paper and presentation is to show the development of methodology and concept from a basic idea to final implementation.", 
		    "authors": [
			"Christian Kandler", 
			"Patrick Wimmer", 
			"Christian Kehrer"
		    ], 
		    "title": "e-MOBILie \u2013 From concept development to HiL test bench"
		}, 
		"55": {
		...
		"57": {
		    "abstract": "This paper presents the development of a system model for a pre-combustion CO2 capture process as part of an integrated gasification combined cycle power plant. This process entails the modelling of highly non-ideal, two-phase multi-component mixtures which are currently not supported by available Modelica media libraries or interfaces.\nTherefore, an interface prototype was developed and tested for the modelling and simulation of the CO2 capture process. Limitations concerning the modelling approach and improvements targeting the computational efficiency are discussed as well as recommendations are concluded for the design of a library for use of external property code in Modelica.", 
		    "authors": [
			"Carsten Trapp", 
			"Francesco Casella", 
			"Teus van der Stelt", 
		...
		"51": {
		    "abstract": "The Analog, the Digital and the Spice3 package of the MSL.Electrical library lack of a huge amount of detailed, easy to use and well documented electronic device models and therefore real electronic simula-tion is not sufficiently possible with the available models. After describing the current status of the packages, ideas and visions to improve the mentioned packages are presented in this paper to discuss them during the 10th Modelica conference. Also a way of organizing the development based on an open source idea is presented.", 
		    "authors": [
			"Kristin Majetta", 
			"Christoph Clauss"
		    ], 
		    "title": "Future Development of Electrical Packages in MSL"
		}, 
		"50": {
		    "abstract": "The goal of the research project enerMAT is the re-duction of energy consumption and CO2 emissions of buildings by means of new tools for the development and planning of highly energy efficient Building Energy Management Systems (BEMS). EnerMAT will create a novel approach for simulation, optimization, and verification that will aim to design a new generation of energy-aware optimized BEMS which will allow an overall cross-trade automatic control of energy flows to maintain user comfort whilst minimizing energy consumption and CO2 emission. The energy-aware optimization will be based on a model-based approach with an overall building system model enabling the assessment of the energy performance for different design and op-eration alternatives of the building automation system in interaction with the building. This system model will allow a simulation-based, energy-aware, global, dynamic, multi-criterial optimization of BEMS. In this paper, the idea, the approach, and the actual state of project research is presented.", 
		    "authors": [
			"Christoph Clauss", 
			"J\u00fcrgen Haufe", 
			"Torsten Blochwitz", 
		...
		"111": {
		    "abstract": "This paper presents the development of Modelica model for the youBot manipulator. Whereas other robotic simulations focus on the robot interaction with its environment, Modelica allows the modeling of the manipulator controllers and motors. The model was developed with a Modelica library for the manipulator\u2019s components which provides modularity, reusability and abstraction. A comparison test with the actual system has been performed to ensure the model accuracy. The test shows promising result and provides possible future work. The Modelica model of the youBot manipulator is freely available.\n", 
		    "authors": [
			"Rhama Dwiputra", 
			"Alexey Zakharov", 
			"Roustiam Chakirov", 
		...
		"100": {
		    ...
		    "title": "Using Fault Augmented Modelica Models for Diagnostics"
		}, 
		"101": {
		...
		"30": {
		    ...
		    "title": "IDOS - (also) a Web Based Tool for Calibrating Modelica Models"
		}, 
		"37": {
		    "abstract": "Pending", 
		    "authors": [
		...
		"36": {
		    ...
		    "title": "Simulation of 2-DOF Motion Simulator Based on Modelica"
		}, 
		"35": {
		...
		"63": {
		    "abstract": "This paper presents the BuildSysPro Modelica library developed by the department of Energy in Buildings and Territories (EnerBaT) of EDF R&D. After a description of the library\u2019s structure and content, BESTEST validation results and a use case are presented.\nThis library is designed to be used in several con-texts including building physics research, global performance evaluation, technology development and impact assessment. It is also a basis for urban and building stock simulation. BuildSysPro is in-tended for a relatively large audience ranging from R&D scientists to building services engineers.\nBuildSysPro contains classes to describe the whole building and its energy systems including envelope components, HVAC systems and other energy conversion devices (DHW, thermal and photovoltaic panels\u2026) and boundary conditions models. The models are designed for static and dynamic use, and for the representation of 0D/1D pure thermal and fluid dynamics. BuildSysPro in its current version contains around 380 models and 130 functions.", 
		    "authors": [
			"Gilles Plessis", 
			"Aurelie Kaemmerlen", 
			"Amy Lindsay"
		    ], 
		    "title": "BuildSysPro: a Modelica library for modelling buildings and energy systems"
		}, 
		"64": {
		    "abstract": "Taking a look at project costs from a financial point of view, the commissioning times of new industrial systems become more and more important, as they significantly drive the costs. Hence, the reduction of commissioning times is part of current research. Besides the use of simulation and the coupling between hardware and software (Hardware-In-The-Loop-Simulations), Rapid Control Prototyping offers a huge potential to reduce commissioning times. Until now, most of the toolchains use special hardware in combination with commercial simulation software, which leads to some serious drawbacks. In this work, a toolchain for Rapid Control Prototyping using industrial controllers and open source software is presented.", 
		    "authors": [
			"Nils Menager", 
			"Niklas Worschech", 
			"Lars Mikelsons"
		    ], 
		    "title": "A toolchain for Rapid Control Prototyping using Rexroth controllers and open source software"
		}, 
		"65": {
		    "abstract": "This contribution presents a Modelica implementation of the generalized power-based modeling approach conforming to the bond graph methodology. The corresponding developed library BondGraph is discussed in detail. It allows graphical modeling according to the bond graph formalism, and contains common bond graph elements, as well as specific nonlinear elements, especially related to hydraulic effects. Furthermore, several composed models are provided, such as switching valves, pipes, cylinders, etc. A combination with blocks of the Modelica Standard Library is possible. The application of BondGraph to an industrial plant is described demonstrating capabilities of the library.", 
		    "authors": [
			"Ilja Alkov", 
			"Robin Diekmann", 
			"Dirk Weidemann"
		    ], 
		    "title": "A Generalized Power-Based Modelica Library with Application to an Industrial Hydraulic Plant"
		}, 
		"66": {
		...
		"91": {
		    ...
		    "title": "Nonlinear State Estimation with an Extended FMI 2.0 Co-Simulation Interface"
		}, 
		"90": {
		...
		"94": {
		    "abstract": "Modern smart systems will provide new functionality by dynamically interacting with each other in cyber-physical systems (CPS). Such interactions require a message-based coordination under hard real-time constraints. Complex software realizes them by combining discrete, state-based behavior with continuous behavior controlling the dynamics of the physical system parts. The development methods and tools for these kinds of software are not well integrated so far. For the modeling and simulation of physical and continuous control behavior, Modelica can be used. For modeling the discrete coordination behavior, MechatronicUML  (MUML) can be used, which in addition offers a formal verification of safety requirements like deadlock-freedom of interactions, for example. In order to bridge the gap between these approaches and to allow an integrated modeling, simulation, and formal verification of CPS software, we introduce in this paper an automatic transformation for formally verified MUML models into Modelica. We illustrate and evaluate this concept by means of a car-to-car coordination scenario.", 
		    "authors": [
			"Uwe Pohlmann", 
			"J\u00f6rg Holtmann", 
			"Matthias Meyer", 
		...
		"19": {
		    ...
		    "title": "Model-Based Design of Integrative Energy Concepts for Building Quarters using Modelica"
		}, 
		"18": {
		    "abstract": "The verification of requirements for the proper design and operation of complex physical systems may be quite difficult, due to the large number of requirements and test scenarios to be considered to have satisfactory test coverage. The purpose of this paper is to present a new architecture to automate the verification of requirements, using different types of models and binding them together to generate automatically the test model. Six types of models are considered: (1) the property model, (2) the architecture model, (3) the behavioral model, (4) the observation model, (5) the engineering database, and (6) the binding model. An example is given to illustrate the new concepts.", 
		    "authors": [
			"Daniel Bouskela", 
			"Thuy Nguyen", 
			"Audrey Jardin"
		    ], 
		    "title": "Innovative Modelling Architecture for the Design Verification against System Requirements"
		}, 
		"117": {
		    "abstract": "So far, when modelling processes that demand for multi-phase and multi-component fluid property data, the user has to implement the required media models in the Modelica language as these types of fluids are not supported by Modelica.Media. This paper presents a first approach on how to implement fluid property data in process models from external sources and highlights which problems have to be overcome. Furthermore, it provides recommendations for the design of an efficient and user-friendly interface to external media packages.", 
		    "authors": [
			"Kai Wellner", 
			"Carsten Trapp", 
			"Gerhard Schmitz", 
		...
		"116": {
		    ...
		    "title": "Adsorption energy systems library - Modeling adsorption based chillers, heat pumps, thermal storages and desiccant systems"
		}, 
		"151": {
		    "abstract": "Systems engineers face the ever increasing chase for reduced time to market, while the systems to develop ever increase in complexity. Software systems design and integration processes have therefor evolved along the well-known V-cycle.\nThis paper will focus on the software integration for mechatronic systems as they develop fast due to high demands and challenging requirements in the automotive industry.\nThe development order of model in the loop (MIL), software in the loop (SIL), processor in the loop (PIL) and hardware in the loop (HIL) can be seen as state of the art practised by many systems engineers. Driver in the loop (DIL) may be in its infancy, but rapidly growing.\nThe novelty presented in this paper is the consistency of the plant models used in the integration chain supporting data-driven modelling: Functional Mock-up Units (FMU) defined by the open standard of the Functional Mock-up Interface1 (FMI).", 
		    "authors": [
			"Edo Drenth", 
			"Mikael T\u00f6rm\u00e4nen", 
			"Krister Johansson", 
		...
		"152": {
		    ...
		    "title": "Augmentation of Modelica Models for Reliability Analysis"
		}, 
		"155": {
		...
		"143": {
		    ...
		    "title": "Grey-box Building Models for Model Order Reduction and Control"
		}, 
		"140": {
		    "abstract": "This paper focuses on the physical design of hydraulic relief and servo valves and its applications. Specifically, this paper serves to illustrate how the physical design parameters of hydraulic components can be incorporated into system modeling and their effect on the system dynamics and stability characteristics. Detailed physical models of a relief valve and a servo valve developed using the Hydraulics Library\u00ae are discussed in this paper with particular emphasis on the effect of design parameters on the stability characteristics. A simple design of experiment (DoE) to illustrate robust design methods for hydraulic system design is also shown with the use of the FMI Toolbox (FMIT) (FMIT) for MATLAB\u00ae.  . Furthermore with the help of these two valve models, we seek to bring to the attention of the community, an important limitation in open loop controls analysis in an acausal modeling environment where the feedback loops are embedded in the physics of the model ", 
		    "authors": [
			"Sureshkumar Chandrasekar", 
			"Hubertus Tummescheit"
		    ], 
		    "title": "Physical Design of HydraulicValves in Modelica"
		}, 
		"141": {
		    "abstract": "The paper presents an approach to modeling a combustion chamber, a component of all aircraft engines. The model proposed accounts for stoichiometry of the combustion process and uses adiabatic flame temperature model to account for thermodynamics.\nThe model is implemented by modifying as necessary the Convert Media element from the Engine Dynamics Library. Test results provide reasonable agreement with published literature.", 
		    "authors": [
			"Dmitry Altshuller"
		    ], 
		    "title": "Modelling of Combustion Processes in Aircraft Engines with Modelica"
		}, 
		"148": {
